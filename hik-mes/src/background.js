...
ipcMain.handle('mysql-msg-invoke', async (event, ...arg) => {
  ...
  switch (arg[0]) {
    ...
    case constant.mysql.querySendBoxByAufnr:
      ...
      break;
    case constant.mysql.clearData:
      await mysql.clearData(JSON.parse(arg[1])).then(res => {
        result.success = true
        result.value = res
      }).catch(err => {
        result.msg = err
      ...
      break;
    case constant.mysql.queryTest:
      await mysql.queryTest().then(res => {
        result.success = true
        result.value = res
      }).catch(err => {
        result.msg = err
      ...
      break;
    case constant.mysql.updateTest:
      await mysql.updateTest(JSON.parse(arg[1])).then(res => {
        result.success = true
        result.value = res
      }).catch(err => {
        result.msg = err
