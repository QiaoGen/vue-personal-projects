 ...
 */
// const plcCommand = {
//     barcdSign: { area: areas.M, wordLen: wordLens.bit, start: 4800, amount: 1, desc: '序列号标识位', reply: 'barcdSign_reply', name: 'barcdSign' },
//     barcdSignError: { area: areas.M, wordLen: wordLens.bit, start: 4801, amount: 1, desc: '序列号错误标识位', reply: 'barcdSignError_reply', name: 'barcdSignError' },
//     barcd: { area: areas.DB, dbNumber: 16, start: 0, size: 20, desc: '序列号', reply: 'barcd_reply', name: 'barcd' },//size => byte
//     weightSign: { area: areas.M, wordLen: wordLens.bit, start: 4808, amount: 1, desc: '称重标识位', reply: 'weightSign_reply', name: 'weightSign' },
//     weight: { area: areas.M, wordLen: wordLens.byte, start: 700, amount: 4, desc: '称重数据', reply: 'weight_reply', name: 'weight' },
//     pkgNumberError: { area: areas.M, wordLen: wordLens.bit, start: 4809, amount: 1, desc: 'mes集成码错误', reply: 'pkgNumberError_reply', name: 'pkgNumberError' },
// }
const plcCommand = {
